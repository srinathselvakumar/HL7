...
#include "../HL7 encrypted/communicationthread.h"
...
QT_MOC_LITERAL(1, 20, 16), // "responseReceived"
QT_MOC_LITERAL(2, 37, 0), // ""
QT_MOC_LITERAL(3, 38, 11), // "std::string"
QT_MOC_LITERAL(4, 50, 8), // "response"
QT_MOC_LITERAL(5, 59, 13), // "errorOccurred"
QT_MOC_LITERAL(6, 73, 5) // "error"

    },
    "CommunicationThread\0responseReceived\0"
    "\0std::string\0response\0errorOccurred\0"
    "error"
};
...
void CommunicationThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->responseReceived((*reinterpret_cast< const std::string(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CommunicationThread::responseReceived)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CommunicationThread::errorOccurred)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void CommunicationThread::responseReceived(const std::string & _t1)
{
...
// SIGNAL 1
void CommunicationThread::errorOccurred(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
